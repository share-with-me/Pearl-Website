...
<head>
<?php
if(isset($_POST['firstname'])&&isset($_POST['lastname'])&&isset($_POST['sex'])&&isset($_POST['sport'])&&isset($_POST['college'])&&isset($_POST['contact'])&&isset($_POST['email']))
{
...
$email=$_POST['email'];
if(mysql_connect('mysql.hostinger.co.uk','u627560233_monil','Custard12345')&&mysql_select_db('u627560233_user'))
    {
$query="INSERT INTO pearlregistration (firstname,lastname,sex,email,college,sport,contact) VALUES ('$firstname','$lastname','$sex','$email','$college','$sport','$contact')";
if(mysql_query($query))
{
echo 'You Have Successfully registered to PEARL \'15';
}
}
}
?>
...
<title>Registration | Pearl 15</title> 
...
.div1 {
	...
	cursor: url(cursor1.png), url(cursor1.png), auto;
...
.btn btn-info{
	cursor: url(cursor2.png), url(cursor2.png), auto;
}
...
<body>
	<div class="div1"></div>
	<div class="contain" style="height:auto; width:auto;">
<form action="pearlregistration.php" name="myForm" onsubmit="return onkeydown();"  method="post" target="">
			<center>
			<h2 style="color:white;">Registration Form</h2>
			<!--<h4>NOTE:</h4><p><b>Only team captains need to register here. For the registrations of the rest of the team, you will be provided a Google document, sent through mail. </p>-->
			<div class="rasberry">
			...
			<div class="conf">
				...
				<label for="gender" id="sexx" class="styled">  Gender :&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp  &nbsp &nbsp &nbsp </label>
				<input type="radio" name="sex" id="gender" class="sexx" value="Male" required>    Male&nbsp &nbsp &nbsp
				<input type="radio" name="sex" id="gender" class="sexx" value="Female" required>                  Female &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp&nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<br><br>
				
				<div class="gam">
				<label for="sport" id="game" >Event mainly interested in :    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp &nbsp</label>
				<select name="sport" class="textboxx">
    ...
    <big><span class="glyphicon glyphicon-hand-up" ></span> Submit</big>
  </button>
				<br><br><br>
				</div>
